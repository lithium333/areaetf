...
foreach ($jarr as $jitem) {
	if($jitem['data']==null) {
		...
		echo "<h3><span class='isitem'>".$i."</span> <b>".$jitem['azienda']."</b>:<br>";
		if(isset($jitem['ral']))
			echo "<span class='isitem'>RAL: </span>".$jitem['ral']."<br>";
		else
			echo "<span class='isitem'>Mese netto: </span>".$jitem['mese']."<br>";
		echo "<span class='isitem'>Mansione: </span>".$jitem['ruolo']."<br>";
		echo $jitem_r."</h3>\n";
	}
	$i++;
}
